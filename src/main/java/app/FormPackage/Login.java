...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelUsername.setForeground(new java.awt.Color(255, 255, 102));
        labelUsername.setText("Username ");

        labelPassword.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        labelPassword.setForeground(new java.awt.Color(255, 255, 102));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (role.equals(Constants.MANAGER) || role.equals(Constants.CASHIER)) {
            ...
            MainScreen homePage = new MainScreen(role, name);
